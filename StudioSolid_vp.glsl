...
#if !defined( STUDIO_FULLBRIGHT ) && ( defined( STUDIO_HAS_BUMP ) || defined( STUDIO_HAS_GLOSS ))
...
#endif
#if defined( STUDIO_HAS_BUMP ) || defined( STUDIO_HAS_GLOSS ) || defined( STUDIO_LIGHTVEC_DEBUG )
