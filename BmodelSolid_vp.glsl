...
#endif//!defined( BMODEL_NOLIGHTMAP ) && !defined( BMODEL_FULLBRIGHT )

#if defined( BMODEL_HAS_GLOSSMAP ) || defined( BMODEL_CUBEMAP_BPCEM ) || defined( BMODEL_CUBEMAP_SIMPLE ) || defined( BMODEL_MIRROR )
